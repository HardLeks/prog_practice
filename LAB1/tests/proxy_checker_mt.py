...
from LAB1.src.proxy_checker_mt import check_proxy_from_file


# @unittest.skip
class TestProxyCheckerMt(unittest.TestCase):
    def setUp(self):
    ...
    def test(self):
        ...
        self.res = check_proxy_from_file(site_list, proxy_path, 3)
